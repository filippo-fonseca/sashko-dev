...
![Animated gif showing how you can open the bookmarklet while looking at a page on The Verge, and it opens a new email in Gmail with a link to that page](blog/bookmarklets/sendwithgmail.gif)
...
![Animated gif showing that you can open a bookmark and it adds a task in the Things app](blog/bookmarklets/addtothings.gif)
